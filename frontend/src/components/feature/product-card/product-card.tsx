export const ProductCard = () => {
    return (
        <>
                <img className="product-container__img" src="./assets/img/content/catalog-product-1.png" srcSet="img/content/catalog-product-1@2x.png 2x" width="90" height="235" alt="" />
